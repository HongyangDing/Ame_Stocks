...
preview、review-bound full build、release 与精确重放；当前顺序硬停点在 S4 schema review 之前。
...
**S2 已结束；S3 现已独立完成，下一硬停点在 S4 schema review 之前。**
...
**S3 至此结束；没有启动 S4，下一硬停点在 S4 schema review 之前。**
