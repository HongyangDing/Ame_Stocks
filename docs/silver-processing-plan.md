...
S0、S1 与 S2 均已完成并发布。S2 的真实 24 行 `ticker_types` preview、review-bound full build
和 release 已通过；当前顺序硬停点在 S3 schema review 之前。
...
**S2 至此结束；没有启动 S3，下一硬停点在 S3 schema review 之前。**
