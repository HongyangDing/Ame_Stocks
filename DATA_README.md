...
暴露出统一合同错把官方 optional 的 `daily_bars.vw` 当成必填。修复后的最终 checkpoint-v7
预留路径为 `manifests/audits/bronze/full-2026-07-12-v7.json`；其实际状态与 SHA 只在报告完整
落盘后填写。文件名中的 v6/v7 是运行 checkpoint；报告内部 schema 仍为 v3。
